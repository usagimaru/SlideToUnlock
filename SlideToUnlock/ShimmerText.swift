...
#Preview {
	ZStack {
		...
		VStack(spacing: 12) {
			...
			ShimmerText(text: "スライドでロック解除", textColor: .gray, _debug: true)
			ShimmerText(text: "スライドでロック解除", textColor: .gray)
			ShimmerText(text: "スライドでロック解除", textColor: .orange, masking: false)
